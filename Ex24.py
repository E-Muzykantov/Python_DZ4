...
len_list = int(input('Введите количество кустов на грядке: '))
garden_bed = [randint(0, 10) for i in range(len_list)]
print(garden_bed)
max = 0
for _ in range(len_list):
    sum3 = sum(garden_bed[-3::])
    garden_bed.insert(0, garden_bed.pop())
    if sum3 > max:
        max = sum3
print(max)